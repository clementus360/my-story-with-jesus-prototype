...
export default function CtaSection() {
  ...
  return (
    <section className="w-full px-20 py-10">
      <div
        ref={ref}
        className={`bg-[#3949ab] rounded-2xl px-[253px] py-20 flex flex-col items-center transition-all duration-700 ease-out ${
      ...
      >
        <div className="max-w-[774px] flex flex-col items-center gap-10 text-center">
          ...
          <Link
            href="/share"
            className="bg-[#f5f5f5] border border-[#3949ab] text-[#3949ab] text-2xl font-medium px-6 py-4 rounded-full hover:bg-white transition-colors"
          >
            Share Your Story
          </Link>
        </div>
